...
$(document).ready(function(){togglemenu();
    if($("body").hasClass("layout-6")||$("body").hasClass("layout-7")){togglemenulayout()}menuhrres();var c=$(window)[0].innerWidth;$('[data-toggle="tooltip"]').tooltip();$('[data-toggle="popover"]').popover();
    ...
    $(".mobile-menu").on("click",function(){var d=$(this);d.toggleClass("on")});
