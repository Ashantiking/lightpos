    ...
    $('body').append('' +
        '<div id="styleSelector" class="menu-styler">' +
            ...
            '<div class="style-block">' +
                '<h4 class="mb-2">Acheampong Inc<small class="font-weight-normal">v8.0 Customizer</small></h4>' +
                '<hr class="">' +
                '<div class="m-style-scroller">' +
                    ...
                    '</div>' +
                '</div>' +
                '<a href="https://web.facebook.com/liven.acheampong.3" class="btn btn-success btn-block m-r-15 m-t-10 m-b-10">Profile</a>' +
                '<a href="https://web.facebook.com/liven.acheampong.3" target="_blank" class="btn btn-primary btn-block m-r-15 m-t-5 m-b-10 ">Online Documentation</a>' +
                '<div class="text-center">' +
                    '<span class="text-center f-18 m-t-15 m-b-15 d-block">Thank you for sharing !</span>' +
                    '<a href="https://web.facebook.com/liven.acheampong.3" target="_blank" class="btn text-white bg-facebook btn-icon m-b-20">' +
                        '<i class="feather icon-facebook"></i>' +
                    '</a>' +
                    '<a href="https://web.facebook.com/liven.acheampong.3" target="_blank" class="btn text-white bg-twitter btn-icon m-l-20 m-b-20">' +
